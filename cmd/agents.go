...
var agentRegistry = map[string]agentInfo{
	"claude": {
		...
		researchCommand: config.AgentCommandSets["claude"].Research,
	},
	"codex": {
		...
		researchCommand: config.AgentCommandSets["codex"].Research,
	},
	"gemini": {
		...
		researchCommand: config.AgentCommandSets["gemini"].Research,
	},
}
