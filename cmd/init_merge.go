...
// mergeCodexConfigTOML merges managed defaults into an existing .codex/config.toml.
// Root-level keys and the [sandbox_workspace_write] section are injected if
// absent; existing values are overwritten to match the managed defaults.
