...
- It invokes the configured agent exactly once with the `scaffold` skill
...
- `doug init` remains the owner of doug-managed control files and provider skill scaffolding
