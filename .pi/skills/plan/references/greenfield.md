...
For greenfield work, the `manifest` block MUST appear in `## Handoff Data`. Do not treat it as optional narrative guidance; the handoff-ready YAML must include the structured manifest data needed for scaffold generation.
